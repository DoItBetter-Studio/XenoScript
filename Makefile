...
linux: $(BIN)/xenoc $(BIN)/xenovm
win64: $(BIN)/xenoc.exe $(BIN)/xenovm.exe

# ==========================================================
# Bootstrap: xar tool (Linux only — used during build)
# ==========================================================

$(BIN)/xar: $(XAR_TOOL_SRCS) | $(BIN)
...
$(BUILD)/core.xar: stdlib/core/*.xeno | $(BIN)/xar $(BUILD)
	@$(BIN)/xar pack stdlib/core/ -o $@ -n core -v 1.0.0

$(BUILD)/math.xar: stdlib/math/*.xeno | $(BIN)/xar $(BUILD)
	@$(BIN)/xar pack stdlib/math/ -o $@ -n math -v 1.0.0
